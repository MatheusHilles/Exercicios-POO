...
public class App4 {
    ...
    System.out.println("O IMC da " + pessoa3.nome + " seria: " + pessoa3.calculoImc());
    System.out.println("O IMC da " + pessoa2.nome + " seria: " + pessoa2.calculoImc());
    System.out.println("O IMC da " + pessoa1.nome + " seria: " + pessoa1.calculoImc());
